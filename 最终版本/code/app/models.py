...
class LiteraryLocation(Base):
    ...
    __table_args__ = (Index("ix_literary_region", "region"),)
...
class NaptanAccessNode(Base):
    ...
    __table_args__ = (
        Index("ix_naptan_stop_type", "stop_type"),
        Index("ix_naptan_admin_area", "administrative_area_code"),
    )
...
class NptgLocality(Base):
    ...
    __table_args__ = (
        Index("ix_nptg_locality_name", "locality_name"),
        Index("ix_nptg_admin_area", "administrative_area_code"),
    )
