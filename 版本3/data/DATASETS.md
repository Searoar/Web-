...
- 本项目已在 `code/scripts/import_local_data.py` 提供示例：将 `film_literary/`、`heritage/`、`dark_skies/` 下样本 CSV **导入 SQLite**（与 `literary_locations`、`dark_sky_sites` 表对应）。在 `code` 目录执行：`python -m scripts.import_local_data`（详见 `code/README.md`）。
