...
class NaptanAccessNodeRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    ...
    nptg_locality_code: str | None
    administrative_area_code: str | None
    status: str | None


class NptgLocalityRead(BaseModel):
    model_config = ConfigDict(from_attributes=True)

    id: int
    nptg_locality_code: str
    locality_name: str
    parent_locality_name: str | None
    administrative_area_code: str | None
    source_locality_type: str | None
    grid_type: str | None
    easting: float | None
    northing: float | None
...
class JourneyStopCreate(BaseModel):
    ...
    naptan_access_node_id: int | None = None
...
class JourneyStopRead(BaseModel):
    ...
    naptan_access_node_id: int | None
    label: str | None
...
class JourneyStopReadExpanded(JourneyStopRead):
    ...
    naptan_access_node: NaptanAccessNodeRead | None = None
